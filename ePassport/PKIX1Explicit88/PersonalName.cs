...
namespace ePassport {
    ...
    [ASN1PreparedElement]
    [ASN1Sequence(Name = "PersonalName", IsSet = true)]
    public class PersonalName : IASN1PreparedElement 
    {
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(PersonalName));
