...
namespace ePassport {
    ...
    [ASN1PreparedElement]
    [ASN1Choice(Name = "SignerIdentifier")]
    public class SignerIdentifier : IASN1PreparedElement 
    {
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(SignerIdentifier));
