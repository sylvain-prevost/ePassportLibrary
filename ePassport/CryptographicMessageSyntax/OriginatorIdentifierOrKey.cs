...
namespace ePassport {
    ...
    [ASN1PreparedElement]
    [ASN1Choice(Name = "OriginatorIdentifierOrKey")]
    public class OriginatorIdentifierOrKey : IASN1PreparedElement 
    {
        ...
        private OriginatorPublicKey originatorKey_;
        private bool  originatorKey_selected = false;

        
		[ASN1Element(Name = "originatorKey", IsOptional = false, HasTag = true, Tag = 1, HasDefaultValue = false)]
        public OriginatorPublicKey OriginatorKey
        {
            get { return originatorKey_; }
            set { selectOriginatorKey(value); }
        }
        ...
        public void selectIssuerAndSerialNumber (IssuerAndSerialNumber val) 
        {
            ...
            this.originatorKey_selected = false;
        ...
        public bool isOriginatorKeySelected()
        {
            return this.originatorKey_selected;
        }

        

        public void selectOriginatorKey (OriginatorPublicKey val) 
        {
            this.originatorKey_ = val;
            this.originatorKey_selected = true;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(OriginatorIdentifierOrKey));
